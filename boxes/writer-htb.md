...
<big> I check website and didnt find anything useful, checked burp and got something useful. </big> <br> <big> On website you can post **story** and we can upload picture where we can do reverse shell through **burp**</big>.<br> <big>Post request looks like this.</big></br>
